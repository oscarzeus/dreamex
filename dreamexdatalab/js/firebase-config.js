...
try {
    // Get the current host - this helps with dynamic authentication domains
    const currentHost = window.location.hostname;
    const isLocalhost = currentHost === 'localhost' || currentHost === '127.0.0.1';
    
    // Use explicit domain for dreamexdatalab.com, fallback to current host for other domains
    let authDomain;
    if (isLocalhost) {
        authDomain = "users-8be65.firebaseapp.com";
    } else if (currentHost === "dreamexdatalab.com" || currentHost.endsWith(".dreamexdatalab.com")) {
        authDomain = "dreamexdatalab.com";
    } else {
